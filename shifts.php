...
<body>
  ...
  <!-- end header inner -->
        ...
        <div class="wrapper" style="position: relative; top: 5em;">
            ...
            <table id="crud">
                <h1>Shifts</h1>
                <button class="btn btn-primary" data-toggle="modal" data-target="#timeSettingsModal">
                    <i class="fa fa-add"></i>
                    Add new
                    shift</button>
                <caption></caption>
                ...
                if ($shifts) {
                    ...
                    foreach ($shifts as $key => $shift) {
                        ...
                        echo "<td>";
                        echo "<button class='btn btn-sm btn-info text-dark border border-dark' style='font: unset;' data-toggle='modal' data-target='#editShiftModal' data-shift-key='" . $key . "' data-shift-name='" . $shift['shiftName'] . "' data-beginning-time='" . $shift['beginningTime'] . "' data-leaving-time='" . $shift['leavingTime'] . "'><i class='fa fa-pencil'></i> Edit</button> ";

                        // Form for deleting the shift
                        echo "<form method='POST' style='display:inline-block;'>";
                        echo "<input type='hidden' name='shiftKey' value='" . htmlspecialchars($key) . "'>";
                        echo "<button type='submit' name='delete_shift' class='btn btn-sm btn-danger text-dark border border-dark' style='font: unset;'  onclick='return confirm(\"Are you sure you want to delete this shift?\");'><i class='fa fa-trash'></i> Delete</button>";
                        echo "</form>";
                    ...
                    echo "<tr><td colspan='3'>No shifts available</td></tr>";
                }
                ?>
                </tbody>
            </table>
        ...
        <!-- end footer -->
        <!-- Modal Structure -->
        <div class="modal fade" id="timeSettingsModal" tabindex="-1" role="dialog"
            aria-labelledby="timeSettingsModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="timeSettingsModalLabel">Shift</h5>
                        <a type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </a>
                    </div>
                    <div class="modal-body">
                        <form method="post" action="shiftsSettings.php">
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control" id="beginningTime" name="beginningTime"
                                    required>
                            </div>
                            <div class="form-group">
...
<div class="modal fade" id="editShiftModal" tabindex="-1" role="dialog" aria-labelledby="editShiftModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="editShift.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" class="form-control" id="editBeginningTime" name="beginningTime" required>
                    </div>
                    <div class="form-group">
                        <label for="editLeavingTime">Allowed Leaving Time:</label>
                        <input type="time" class="form-control" id="editLeavingTime" name="leavingTime" required>
                    </div>
